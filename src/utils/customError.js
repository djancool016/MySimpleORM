...
const errorCode = {
    ...
    '23505': createError(409, 'DB_Error', 'ER_DUP_ENTRY', 'Duplicate entry'),
    ...
    '42P02': createError(400, 'DB_Error', '42P02', 'Undefined parameter'),
    '42601': createError(400, 'DB_Error', '42601', 'Syntax error'),
    ...
    '08P01': createError(404, 'DB_Error', 'ER_NOT_FOUND', 'Resource not found'),
